...
type Elogger struct {
	name           string
	cfg1           *Cfg               // config by manual
	cfg2           *LoggerCfg         // real used by elog, generated by cfg1 automatically
	option         *option
}

var (
	loggers  = map[string]*Elogger{}          // record all loggers
	mu       sync.Mutex
)
